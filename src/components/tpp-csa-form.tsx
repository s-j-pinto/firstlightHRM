...
const PrintFooter = () => (
    <div className="print-footer-content hidden print:block text-xs text-gray-500">
        <div className="flex justify-between w-full">
            <span>Each franchise of <strong>FirstLight Home Care</strong> Franchising, LLC is independently owned and operated.</span>
     ...
     <div className="printable-area">
        ...
        <Form {...form}>
            <form className="space-y-8">
                ...
                <p className="text-sm">Each franchise of <strong>FirstLight Home Care</strong> Franchising, LLC is independently owned and operated. This Client Service Agreement (this "Agreement") is entered into between the client, or his or her authorized representative, (the “Client”) and <strong>FirstLight Home Care</strong> of Rancho Cucamonga (“<strong>FirstLight Home Care</strong>”).</p>
                ...
                <p className="text-sm"><strong>FirstLight Home Care</strong> will provide non-medical in-hime services (the “services”) specified in the Payor’s authorization and/or Client plan of care as made available by Payor to <strong>FirstLight Home Care</strong> pursuant to the “Payor Agreement”  (as defined below). It is anticipated that Payor will provide Client-specific information to <strong>FirstLight Home Care</strong> as part of the Payor’s authorization and/or Client plan of care as <strong>FirstLight Home Care</strong> needs to render the Services and be reimbursed for such Services by the Payor. However Client will cooperate with <strong>FirstLight Home Care</strong> to the extent <strong>FirstLight Home Care</strong> requires additional information from Client related to Client in order to provide the Services.</p>
...
provisions of state and federal law. A separate <strong>FirstLight Home Care</strong> Private Pay Client Service Agreement must be executed prior to initiation of Private Pay Services.</p>
                ...
                <div className="space-y-6 break-before-page">
                    ...
                    <ol className="space-y-2 text-sm text-muted-foreground list-decimal list-inside">
                        {terms.map((term, index) => {
                            ...
                            const isHiringTerm = term.title === "HIRING";
                            return (
                                <li key={index} className="space-y-1">
                                    <span>
                                        <span className="font-bold">{index + 1}. {term.title}</span>
                                        <span dangerouslySetInnerHTML={{ __html: ' ' + term.text.replace(/<strong>FirstLight Home Care of Rancho Cucamonga<\/strong>/g, '<strong>FirstLight Home Care</strong>') }} />
                                    </span>
                                    {isHiringTerm && (
                ...
                {receivedTransportationWaiver && (
                    <div className="space-y-6 break-before-page">
                        ...
                        <p className="text-sm"><strong>FirstLight HomeCare</strong> offers transportation as a convenience to our clients, not as a standalone service.</p>
                        <p className="text-sm">Upon signing of this waiver, I understand I am authorizing an employee of <strong>FirstLight HomeCare</strong> to furnish transportation for me as a passenger in either their automobile or my own.</p>
                        <p className="text-sm">I will follow all applicable laws, including, but not limited to, the wearing of my seatbelt.</p>
                        <p className="text-sm">When the <strong>FirstLight HomeCare</strong> employee drives my vehicle, I certify current insurance for both liability and physical damage.</p>
                        ...
                        <p className="text-sm">I specifically accept these risks and waive any claim that I might otherwise have against <strong>FirstLight HomeCare</strong> with respect to bodily injury or property damage sustained by me in connection with said transportation, and hereby expressly release <strong>FirstLight HomeCare</strong> and their employees from any and all liability therewith.</p>
  ...
  return (
     <Card>
        ...
        <CardFooter className="flex justify-center text-xs text-muted-foreground pt-4 no-print">
            <p>Each franchise of <strong>FirstLight Home Care</strong> Franchising, LLC is independently owned and operated.</p>
        </CardFooter>
    </Card>
  );
}
