                ...
                <form className="space-y-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <ol className="space-y-4 text-sm text-muted-foreground list-decimal list-inside">
                            ...
                            <li><strong>INFORMATION AND DOCUMENTS RECEIVED:</strong> The Client acknowledges receipt of a copy of this Agreement, these Terms and Conditions and the following documents provided by FirstLight Home Care of Rancho Cucamonga and agrees to be bound by and comply with all of the same:</li>
                        </ol>
                    </div>
