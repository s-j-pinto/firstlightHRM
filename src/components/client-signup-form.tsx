...
import { useDoc, useMemoFirebase, useFirestore, errorEmitter, FirestorePermissionError } from "@/firebase";
            ...
            <form className="space-y-8">
                ...
                <div className="space-y-6 break-before-page">
                    ...
                    <ol className="space-y-4 text-sm text-muted-foreground list-decimal list-inside">
                        {privatePayTerms.map((term, index) => (
                            <li key={index} className="space-y-1">
                                <span><span className="font-bold">{term.title}</span><span dangerouslySetInnerHTML={{ __html: ' ' + term.text.replace(/FirstLight Home Care of Rancho Cucamonga/g, '<strong>FirstLight Home Care of Rancho Cucamonga</strong>') }} /></span>
                                {term.title === "11. INSURANCE:" && (
                                ...
                                {term.title === "19. INFORMATION AND DOCUMENTS RECEIVED:" && (
