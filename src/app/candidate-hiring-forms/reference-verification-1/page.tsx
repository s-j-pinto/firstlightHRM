...
import { referenceVerification1Schema, referenceVerification1Object, type ReferenceVerification1FormData, type CaregiverProfile, type OnboardingSignatures } from "@/lib/types";
                ...
                <div className="space-y-4">
                    <h3 className="text-lg font-semibold">FORMER EMPLOYER CONTACT INFORMATION</h3>
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <FormField control={form.control} name="emailOrFax1" render={({ field }) => ( <FormItem><FormLabel className="bg-yellow-200/70 p-1 rounded inline-block">Supervisor's Email and/or Fax #</FormLabel><FormControl><Input {...field} /></FormControl><FormMessage /></FormItem> )} />
                        <FormField control={form.control} name="phone1" render={({ field }) => ( <FormItem><FormLabel className="bg-yellow-200/70 p-1 rounded inline-block">Supervisor's Phone</FormLabel><FormControl><Input {...field} /></FormControl><FormMessage /></FormItem> )} />
                         <FormField control={form.control} name="employmentDates1" render={({ field }) => ( <FormItem><FormLabel className="bg-yellow-200/70 p-1 rounded inline-block">Dates of Employment (MM/YYYY - MM/YYYY)</FormLabel><FormControl><Input {...field} /></FormControl><FormMessage /></FormItem> )} />
