...
import { loginCandidate } from "@/lib/candidate-auth.actions";
...
export default function CandidateLoginPage() {
  ...
  const onSubmit = (data: LoginFormValues) => {
    startTransition(async () => {
      const result = await loginCandidate(data.email, data.password);
      ...
      try {
        ...
        toast({
          ...
          description: "Welcome! Redirecting to your hiring forms.",
        });
    ...
    <main className="flex items-center justify-center min-h-[calc(100vh-8rem)]">
      <Card className="w-full max-w-sm mx-auto shadow-lg">
        <CardHeader className="text-center">
            ...
            />
          <CardTitle className="text-2xl font-bold font-headline">Candidate Hiring Portal</CardTitle>
          <CardDescription>
            Please log in to complete your hiring forms.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
