...
export async function generateLic508Pdf(formData: any): Promise<{ pdfData?: string; error?: string }> {
    try {
        ...
        drawText(page, "Authority:", { x: leftMargin, y, font: boldFont, size: mainFontSize }); y -= lineHeight;
        ...
        drawText(page, "Principal Purpose:", { x: leftMargin, y, font: boldFont, size: mainFontSize }); y -= lineHeight;
        ...
        drawText(page, "Routine Uses:", { x: leftMargin, y, font: boldFont, size: mainFontSize }); y -= lineHeight;
