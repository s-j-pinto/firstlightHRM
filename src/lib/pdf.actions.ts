...
export async function generateClientIntakePdf(formData: any, formType: 'private' | 'tpp' = 'private') {
    ...
    if (formData.receivedTransportationWaiver) {
        ...
        y = drawWrappedTextWithBoldHighlight(page, "FirstLight HomeCare offers transportation as a convenience to our clients, not as a standalone service.", "FirstLight HomeCare", font, boldFont, mainFontSize, leftMargin, y, contentWidth, lineSpacing);
        y -= lineSpacing;
        y = drawWrappedTextWithBoldHighlight(page, "Upon signing of this waiver, I understand I am authorizing an employee of FirstLight HomeCare to furnish transportation for me as a passenger in either their automobile or my own.", "FirstLight HomeCare", font, boldFont, mainFontSize, leftMargin, y, contentWidth, lineSpacing);
        y -= lineSpacing;
        ...
        y -= lineSpacing;
        y = drawWrappedTextWithBoldHighlight(page, "When the FirstLight HomeCare employee drives my vehicle, I certify current insurance for both liability and physical damage.", "FirstLight HomeCare", font, boldFont, mainFontSize, leftMargin, y, contentWidth, lineSpacing);
        y -= lineSpacing;
        ...
        y -= lineSpacing;
        y = drawWrappedTextWithBoldHighlight(page, "I specifically accept these risks and waive any claim that I might otherwise have against FirstLight HomeCare with respect to bodily injury or property damage sustained by me in connection with said transportation, and hereby expressly release FirstLight HomeCare and their employees from any and all liability therewith.", "FirstLight HomeCare", font, boldFont, mainFontSize, leftMargin, y, contentWidth, lineSpacing);
        y -= sectionSpacing * 3;
